...
//{{%PRESERVE%
// ここにコードを入力して下さい
plugins.options["bmany.default_open_type"] = "tabshifted";
...
plugins.options["tanything_opt.keymap"] = {
    ...
    "M-p"   : "localLeftclose",                 //選択したタブの左にあるタブをすべて閉じる
    "M-n"   : "localRightclose",                //選択したタブの右にあるタブをすべて閉じる
...
// 動的略語展開（小文字で開始しても大文字に展開可能）
plugins.options["dabbrev.next_key"] = "C-j"; //展開
plugins.options["dabbrev.prev_key"] = "M-j"; //ひとつ前の候補に戻る
...
// dabbrevプラグイン（小文字で開始しても大文字に展開可能）
